    ...
    return (
        <div className='grid grid-cols-12 gap-4 p-4 h-[calc(100vh)] bg-gradient-to-b from-background to-background-secondary'>
            <div className='col-start-1 col-span-3 p-4 flex flex-col text-text bg-primary shadow-lg rounded-3xl overflow-hidden'>
                ...
                <div className='overflow-y-auto border-2 rounded-3xl border-accent text-lg' style={{ maxHeight: '900px' }}>
                    {users.map((user) => (
            ...
            <div className='col-start-4 col-span-9 flex flex-col text-white gap-4 mr-2 bg-primary shadow-lg rounded-3xl overflow-hidden py-2 px-3'>
                <div className="messages flex-grow overflow-y-auto overflow-x-hidden border-2 rounded-3xl border-accent pl-3 bg-primary pr-3">
